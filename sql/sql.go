...
import (
	...
	"github.com/jananiv/sqltest/iam"
)
...
func GetServer(ctx context.Context, resourcegroup, servername string) (sql.Server, error) {
...
func CreateServer(ctx context.Context, resourcegroupname, location, serverName, dbLogin, dbPassword string) (server sql.Server, err error) {
	serversClient := getServersClient()
...
func CreateDB(ctx context.Context, resourcegroup, location, serverName, dbName string) (db sql.Database, err error) {
